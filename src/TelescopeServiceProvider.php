...
use Laravel\Telescope\Storage\Influx\DatabaseEntriesRepository as InfluxDBRepository;
...
class TelescopeServiceProvider extends ServiceProvider
{
    ...
    protected function registerInfluxDriver()
    {
        $this->app->singleton(
            EntriesRepository::class,
            InfluxDBRepository::class
        );

        $this->app->when(InfluxDBRepository::class)
            ->needs('$config')
            ->give(config('telescope.storage.influx'));
    }
}
